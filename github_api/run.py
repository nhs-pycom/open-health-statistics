...
import github_api.github as github

# Load in the config parameters
with open("org_list.yaml", "r") as f:
...
# Tidy the raw data
df = github.tidy_raw_df(raw_github_df)
...
# save file to .csv
aggregate_df.to_csv("data/openhealthstats.csv", index=False)
