        ...
        while True:
            try:
                ...
                if e.response.status_code == 403:
                    print(f"Rate limit exceeded for organisation {org}.")
                    if retries >= max_retries:
                        print(f"Max retries exceeded for organisation {org}. Moving on.")
                        break
...
df = github_api_call.query_org_repos({'Open AI': 'openai', 'Google': 'google'}, max_retries=3)
```